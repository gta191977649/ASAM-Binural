...
TMP_WEIGHT_FOLDER = 'binuaral_weight_mag'
TMP_WEIGHT_FOLDER_BIN = 'binuaral_weight_mag'
...
ADD_BGD_NOISE = False
BGD_NOISE_WAV = None
BGD_NOISE_FILE = '/home/nurupo/Desktop/dev/ASAM-master/dataset/BGD_150203_010_STR.CH1.wav'
ROOM = 'Anechoic'
RTF_DIR = '/home/nurupo/Desktop/dev/HRTF_SURREY'
...
def init_config():
    ...
    global LOC_1
    LOC_1 = eval(_config.get('cfg', 'LOC_1').strip())
    global LOC_2
    LOC_2 = eval(_config.get('cfg', 'LOC_2').strip())
    global EAR
    EAR = eval(_config.get('cfg', 'EAR').strip())
    ...
    global ROOM
    # ROOM = eval(_config.get('cfg', 'ROOM').strip())
    ROOM = 'Anechoic'
    global HRTF_DIR
    HRTF_DIR = '/home/nurupo/Desktop/dev/HRTF_SURREY'
    cfg_file.close()
...
def log_config(_log_file):
    ...
    _log_file.write('LOC_1:' + str(LOC_1) + '\n')
    _log_file.write('LOC_2:' + str(LOC_2) + '\n')
    _log_file.write('ROOM' + ROOM + '\n')
    if EAR == 1:
        _log_file.write('EAR:' + str('LEFT') + '\n')
    else:
        _log_file.write('EAR:' + str('RIGHT') + '\n')
    if ADD_BGD_NOISE:
